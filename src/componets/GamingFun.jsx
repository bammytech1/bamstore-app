    ...
    <section className='w-full block items-center justify-center'>
        <div className=' relative w-full block'>
            ...
            <div className='absolute top-10 md:top-20 left-1/2 -translate-x-1/2 block '>
                <h2 className='text-light text-center  text-lg md:text-4xl lg:text-6xl font-bold mb-2 '>Get More Fun With Us</h2>
                <p className='text-green-50 text-center text-sm md:text-2xl font-bold  mb-2 md:md-4'>One of a Kind Gaming Experience</p>
